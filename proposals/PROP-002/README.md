...
Currently PR 27 (https://github.com/komacke/hamclock/pull/27) is a change to HamClock that would direct these requests to the backend. The backend would need to handle them.
